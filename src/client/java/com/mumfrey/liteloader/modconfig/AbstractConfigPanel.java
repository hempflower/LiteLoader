...
public abstract class AbstractConfigPanel implements ConfigPanel
{
    ...
    class GuiConfigTextField extends GuiTextField
    {
        ...
        public boolean getEnableBackgroundDrawing()
        {
            ...
            {
                drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, 0xFFFF5555);
        ...
        public void drawTextBox(int mouseX, int mouseY)
        {
            ...
            if (!this.isValid())
        {
                drawRect(this.xPosition + this.width - 10, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 0x66000000);
                this.fontRenderer.drawString("\247l!", this.xPosition + this.width - 6, this.yPosition + (this.height / 2) - 4, 0xFFFF5555);
    ...
    {
        GuiConfigTextField textField = new GuiConfigTextField(id, this.mc.fontRendererObj, x + 2, y, width, height);
    ...
    protected final void drawHoveringText(String text, int x, int y)
    {
        ...
        {
            GuiLiteLoaderPanel.drawTooltip(this.mc.fontRendererObj, text, x, y, Integer.MAX_VALUE, Integer.MAX_VALUE, 0xFFFF5555, 0xB0000000);
