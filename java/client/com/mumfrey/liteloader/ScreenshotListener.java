...
{
	/**
	 * Called when a screenshot is taken, mods should return FALSE to suspend further processing, or TRUE to allow
	 ...
	 * @return FALSE to suspend further processing, or TRUE to allow processing to continue normally
	 */
