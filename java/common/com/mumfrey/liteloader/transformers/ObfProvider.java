...
/**
 * Interface for dynamic (context-specific) obfuscation provider, used internally by ModEventInjectionTransformer to
 * provide obf entries for the AccessorTransformer from JSON 
 * 
