...
/**
 * Exception to throw if startSection or endSection are called from a thread other than 
 * the Minecraft main thread. This should NEVER happen and is an attempt to identify the
 * culprit of some profiler stack corruption causes.
 *
