 ...
 * 
 * Core Providers are objects whose lifecycle is equivalent to the run time of game and thus the entire
 * lifecycle of your API, they are instanced early in the loader startup process. CoreProviders can implement
 * any Observer interface as appropriate and are automatically considered when allocating Observers to
 * callback lists
 * 
